...
class MonitoringAppMass:
    ...
    def LayoutSidebar(self):
        #return pn.Column("# Hello from MonitoringAppMass", self.app.sidebar[0])
        #return self.app.sidebar[0]
        return pn.Card(self.app.sidebar[0], title='Parâmetros', collapsed=False)


    def LayoutMain(self):
        #return pn.Column("# Hello from MonitoringAppMass", self.tab1)
        return self.tab1
